        ...
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="meta_description"><b>Meta Deskripsi</b> (<span class="char-count">{{ strlen($product->meta_description) }}</span>/160)</label>
                            <textarea class="form-control" name="meta_description" id="meta_description">{{ $product->meta_description }}</textarea>
