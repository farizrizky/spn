...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Ubah Testimonial</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('cms.testimonial.update', $testimonial->id) }}" class="needs-validation" novalidate enctype="multipart/form-data">
                        @csrf
                        <div class="form-group form-inline row">
                            <label for="name" class="col-md-3 col-form-label text-wrap"><b>Nama</b></label>
                            <div class="col-md-9 p-0">
                                <input type="text" class="form-control input-full" value="{{ $testimonial->name }}" name="name" id="name" required>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <input type="text" class="form-control input-full" value="{{ $testimonial->job }}" name="job" id="job" required>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <textarea class="form-control input-full" name="testimonial" id="testimonial" rows="4" required>{{ $testimonial->testimonial }}</textarea>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <input type="hidden" name="image_path" id="image_path" value="{{ $testimonial->image_path }}" required>
                                ...
                                <hr>
                                <img id="imagePreview" class="img-fluid mt-2" src="{{ $testimonial->image_path }}" alt="Preview Gambar" />
                            </div>
                        </div>
                         <div class="form-group form-inline row">
                            <label for="logo" class="col-md-3 col-form-label text-wrap"><b>Logo</b></label>
                            <div class="col-md-9 p-0">
                                <input type="hidden" name="logo_path" id="logo_path" value="{{ $testimonial->logo_path }}" required>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <hr>
                                <img id="logoPreview" class="img-fluid mt-2" src="{{ $testimonial->logo_path }}" alt="Preview Logo" />
                            </div>
                        </div>
                        <div class="form-group form-inline row">
...
<script>
    $(document).ready(function(){
        ...
        if ($('#logo_path').val()) {
            $('#logoPreview').attr('src', $('#logo_path').val()).show();
            $('#removeLogo').show();
        }
