...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Blog Baru</h3>
        </div>
        <div class="ms-md-auto py-2 py-md-0">
            <a href="#" id="saveBlog" class="btn btn-success"><i class="fas fa-save"></i> Simpan</a>
        </div>
    </div>
    <form method="POST" action="{{ route('cms.blog.store') }}" class="needs-validation" novalidate enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="meta_description"><b>Meta Deskripsi</b> (<span class="char-count">0</span>/160)</label>
            ...
            <div class="col-md-5">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control input-full datepicker" value="{{ old('date') }}" name="date" id="date" required>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <img id="imagePreview" src="" class="img-fluid mb-3" style="width: 100%; object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
