...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Ubah Client</h3>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('cms.client.update', $client->id) }}" class="needs-validation" novalidate enctype="multipart/form-data">
                        @csrf
                        <div class="form-group form-inline row">
                            <label for="name" class="col-md-3 col-form-label text-wrap"><b>Nama</b></label>
                            <div class="col-md-9 p-0">
                                <input type="text" class="form-control input-full" value="{{ $client->name }}" name="name" id="name" required>
                        ...
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <input type="hidden" name="image_path" id="image_path" value="{{ $client->image_path }}" required>
                                ...
                                <hr>
                                <img id="imagePreview" class="img-fluid mt-2" src="{{ $client->image_path }}" alt="Preview Gambar" />
                            </div>
                        </div>
                        <div class="form-group form-inline row">
                            ...
                            <div class="col-md-9 p-0">
                                <select name="is_active" id="is_active" class="form-select input-full" required>
                                    <option value="1" {{ $client->is_active == 1 ? 'selected' : '' }}>Aktif</option>
                                    <option value="0" {{ $client->is_active == 0 ? 'selected' : '' }}>Tidak Aktif</option>
                                </select>
